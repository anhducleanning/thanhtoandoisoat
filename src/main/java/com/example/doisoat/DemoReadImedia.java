...
public class DemoReadImedia {
    ...
    public static void main(String[] args) throws IOException, ParseException {
        DemoReadImedia readImedia = new DemoReadImedia();


        final String excelFilePath = "C:\\Users\\Administrator\\Desktop\\fileDoiSoat\\buycard.xls";
        ...
        Map<String,TransEntity> topUp =  readInmedia(link,TimeS,TimeE);
        Map<String,TransEntity> buyCard =  readInmedia(excelFilePath,TimeS,TimeE);
        Map<String,TransEntity> temp =  readInmedia(excelFilePath,TimeS,TimeE);

        temp.putAll(topUp);
        temp.putAll(buyCard);
        for (String key : temp.keySet()) {
            TransEntity value = temp.get(key);
...
//        Map<String,TransEntity> maps =  readInmediaBuyCard(path,TimeSt,TimeEn);
